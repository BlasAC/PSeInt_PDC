...
Algoritmo enc09_ejer03

//Esta versión del programa enc09_ejer03 es funcionalmente idéntica a la otra (enc09_ejer03 - Informe de notas),
//pero considerablemente más difícil de entender.
//Solo cambié los nombres de las variables, modifiqué el indentado (eliminé las tabulaciones) y removí
//los saltos de línea que separaban los distintos bloques.
