...
Algoritmo enc18a21_extras05
	
	//Este es uno de esos ejercicios que sé que requiere de comentarios más exhaustivos, pero no
	...
	//Toda la lógica de este condicional podría, y quizá debería, estar en una función encargada
	//de mover, si posible, el contenido del vector. Sumaría claridad a lo que hace el bloque.
